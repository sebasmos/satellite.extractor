...
More in https://docs.sentinel-hub.com/api/latest/user-guides/cloud-masks/#cloud-masks-and-cloud-probabilities
...
def main(CLIENT_ID, CLIENT_SECRET, coordinates):
    ...
    request_all_bands = SentinelHubRequest(
        ...
        evalscript=evalscript_rbg_clm,
        input_data=[
            SentinelHubRequest.input_data(
                data_collection=DataCollection.SENTINEL2_L1C,
                time_interval=('2016-03-27', '2017-04-30'),
